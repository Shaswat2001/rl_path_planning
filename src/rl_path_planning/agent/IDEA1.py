import numpy as np
import torch
from rl_path_planning.pytorch_utils import hard_update
import os
...
class IDEA1:
    ...
    def save(self,env):
        ...
        os.makedirs("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea1_weights", exist_ok=True)
        torch.save(self.PolicyNetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea1_weights/actorWeights.pth")
        torch.save(self.Qnetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea1_weights/QWeights.pth")
        torch.save(self.SafePolicyNetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea1_weights/safeactorWeights.pth")

    def load(self,env):

        self.PolicyNetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea1_weights/actorWeights.pth"))
        self.Qnetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea1_weights/QWeights.pth"))
        self.SafePolicyNetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea1_weights/safeactorWeights.pth"))
