...
class IDEA4:
    ...
    def save(self,env):
        ...
        os.makedirs("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea4_weights", exist_ok=True)
        torch.save(self.PolicyNetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea4_weights/actorWeights.pth")
        torch.save(self.TargetPolicyNetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea4_weights/targetactorWeights.pth")
        torch.save(self.Qnetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea4_weights/QWeights.pth")

    def load(self,env):

        self.PolicyNetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea4_weights/actorWeights.pth"))
        self.TargetPolicyNetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea4_weights/targetactorWeights.pth"))
        self.Qnetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/idea4_weights/QWeights.pth"))
