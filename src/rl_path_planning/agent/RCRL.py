...
class RCRL:
    ...
    def save(self,env):
        ...
        os.makedirs("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/rcrl_weights", exist_ok=True)
        torch.save(self.PolicyNetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/rcrl_weights/actorWeights.pth")
        torch.save(self.Qnetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/rcrl_weights/QWeights.pth")

    def load(self,env):

        self.PolicyNetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/rcrl_weights/actorWeights.pth"))
        self.Qnetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/rcrl_weights/QWeights.pth"))
