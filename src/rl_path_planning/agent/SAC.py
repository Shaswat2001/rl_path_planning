...
class SAC:
    ...
    def save(self,env):
        ...
        os.makedirs("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+ env + "/sac_weights", exist_ok=True)
        torch.save(self.VNetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+env+"/sac_weights/VWeights.pth")
        torch.save(self.TargetVNetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+env+"/sac_weights/TargetVWeights.pth")
        torch.save(self.Qnetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+env+"/sac_weights/criticWeights.pth")
        torch.save(self.PolicyNetwork.state_dict(),"src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+env+"/sac_weights/actorWeights.pth")

    def load(self,env):
        print("-------LOADING NETWORK -------")
        
        self.PolicyNetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+env+"/sac_weights/actorWeights.pth"))
        self.VNetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+env+"/sac_weights/VWeights.pth"))
        self.TargetVNetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+env+"/sac_weights/TargetVWeights.pth"))
        self.Qnetwork.load_state_dict(torch.load("src/rl_path_planning/src/rl_path_planning/config/saves/training_weights/"+env+"/sac_weights/criticWeights.pth"))